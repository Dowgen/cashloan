            ...
            return {
                ...
                questionList:[{
                    ...
                    answers:[
                        ...
                        'A：未完成借款期间，用户不可自行更换银行卡，您可联系客服重置借款状态，重新绑定银行卡。客服电话:0571-28810397'
                    ]
                },{
                    img:3,
                    imgStyle:{
                    ...
                    answers:[
                        ...
                        '（4）代扣失败、主动还款失败、还款成功账单未更新、无法操作还款请联系客服：电话0571-28810397',
                        'A：若未在还款日前进行还款或恶意拖欠导致还款失败，即为逾期，将产生滞纳金。您的逾期情况将记录在网络征信系统。\n' +
                        '遇到逾期情况请不要着急，如为到期当日无法操作还款导致逾期，或已还款但还款状态未更新导致逾期，请联系客服0571-28810397，我们会第一时间为您处理。\n' +
                        '\n' +
